...
HookBase: Base class for hooks that can be registered with TrainerBase
TrainerBase: Base class for iterative trainer with hooks, inherit it.
SimpleTrainer: Example trainer of single-cost single-optimizer single-data-source iterative optimization
AMPTrainer: Example trainer using PyTorch's native automatic mixed precision
