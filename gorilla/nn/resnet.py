...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=1000):
        ...
        self.layer1 = self._make_layer(block, 64, num_blocks[0]) # [56, 56, 64]
        self.layer2 = self._make_layer(block, 128, num_blocks[1], stride=2) # [28, 28, 128]
        self.layer3 = self._make_layer(block, 256, num_blocks[2], stride=2) # [14, 14, 256]
        self.layer4 = self._make_layer(block, 512, num_blocks[3], stride=2) # [7, 7, 512]
